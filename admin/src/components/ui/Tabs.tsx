...
export default function Tabs({ tabs }: { tabs: Tab[] }) {
  ...
  return (
    <div>
      {/* Ряду вкладок на телефоне тесно — своя горизонтальная прокрутка вместо переноса или раздувания страницы. */}
        ...
        <div role="tablist" className="flex gap-1 border-b border-zinc-200">
          {tabs.map((t) => (
            <button
              ...
              className={`-mb-px shrink-0 border-b-2 px-4 py-2 text-sm font-medium transition-colors disabled:cursor-not-allowed disabled:opacity-40 ${
