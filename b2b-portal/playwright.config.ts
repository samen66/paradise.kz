 ...
 * docs/e2e-runbook.md.
 *
 * Проект `setup` заходит в портал оптовиком прогона и сохраняет сессию; на неё
 * опираются тесты, которым нужен вход. Гостевые тесты объявляют пустой
 * storageState сами.
 */
