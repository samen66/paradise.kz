    ...
    <div className="min-h-screen flex items-center justify-center bg-surface p-4">
      <div className="max-w-lg bg-white rounded-2xl shadow-sm p-8 text-center border border-line">
        ...
        <p className="text-muted mb-8 leading-relaxed">
          Ваш оптовый аккаунт успешно создан, но в данный момент находится на модерации.
          Наш менеджер свяжется с вами для подтверждения данных, после чего вам откроется
          доступ к каталогу и оптовым ценам.
        </p>

        <div className="space-y-3">
          <a
            href={process.env.NEXT_PUBLIC_B2C_URL ?? "https://paradise.kz"}
