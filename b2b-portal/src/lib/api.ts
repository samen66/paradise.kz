// Thin typed wrapper around the Laravel public API.
// Server components fetch through API_URL_INTERNAL (docker-network hostname);
// the browser falls back to NEXT_PUBLIC_API_URL.
