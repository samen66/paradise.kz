        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted">
              <li><Link href="/b2b/catalog" className="hover:text-ink transition">Каталог</Link></li>
              <li><Link href="/b2b/orders" className="hover:text-ink transition">Мои заказы</Link></li>
              <li><Link href="/b2b/cart" className="hover:text-ink transition">Корзина</Link></li>
            </ul>
          </div>
          <div>
