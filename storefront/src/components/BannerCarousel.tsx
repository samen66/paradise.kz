    ...
    >
      <div className="grid min-h-[480px] md:grid-cols-[1fr_1.2fr] lg:min-h-[70vh]">
        ...
        <div className="relative min-h-64 md:min-h-0 bg-card overflow-hidden">
          ...
          <div className="absolute bottom-6 right-6 z-20 flex h-20 w-20 flex-col items-center justify-center rounded-full bg-surface/95 text-center shadow-lg backdrop-blur-sm animate-[scale-in_0.5s_ease-out_0.2s_both]">
