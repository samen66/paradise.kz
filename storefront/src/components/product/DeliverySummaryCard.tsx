...
export function DeliverySummaryCard({
  ...
  return (
    <div className="flex flex-col gap-3 rounded-[20px] border border-line bg-white p-5 text-sm shadow-[0_1px_2px_rgba(28,26,23,0.04),0_12px_32px_rgba(28,26,23,0.05)] sm:px-7 sm:py-[22px]">
