...
return [
    ...
    'helpers' => [
        'erp_readonly' => 'Редактируется в админ-панели (раздел «Товары»). Здесь только просмотр.',
        'stock_readonly' => 'Остаток считается по складскому журналу. Чтобы его изменить — проведите приёмку или корректировку.',
        'b2b_min_qty' => 'Оставьте пустым — будет использовано глобальное значение из Настроек каталога.',
        'in_tenge' => 'Указывается в тенге.',
        'is_active' => 'Локальный флаг: скрыть/показать этот товар.',
        'compare_at_price' => 'Необязательно. Если указана и выше текущей цены, на витрине показывается бейдж скидки.',
        'is_new_arrival' => 'Локальный флаг: показывать бейдж "Новинка" на витрине.',
    ],
